...
% Experimental plan Første avsnitt
% Du bruker forskjellige betegnelser som seach og methods
% 
% Figurer og tabeller skal angis kronologisk. Dvs figure 3.1 før 3.2 etc. Figure 5.5.føt 5.6 etc
% Alle figurene må omtales og henvises til i teksten. Kan ikke se henvisning til fig 3.7 
% Angi figure tekst under figur. Det gjør du some regel.men ikke for figur 5.4 og 5.6
% Figure 5.4 bruke forskjellige symbol eller tydeligere fargeforskjeller på de to grafene
% Tabell tekst over tabell
% 
